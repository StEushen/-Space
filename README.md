...
This repository keeps the model-theme content of PPN and the supporting time-series benchmark scaffold:
- model architecture
- intrinsic time modeling
...
`L_corr = mean(ReLU(MSE_partition - MSE_global_baseline + margin_mu))`
